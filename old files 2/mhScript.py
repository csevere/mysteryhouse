...
#
#
# 	Look for  2 notes in the library:
# 		Beautiful Lady is in there
#
# 		Note 1: Zkdw jrhv edfn dqg iruwk frqvwdqwob, exw qhyhu lq d vwudljkw olqh?
# 			○ prompt user input: "It's a cipher! Guess the number of shift to figure out:  "
# 				§ user input == "3"
# 				§ What goes back and forth constantly, but never in a straight line?
#
# 			○ prompt user input: What's the answer?
# 				§ answer == something else >>> Wrong. Try again
# 				§ answer === something else 3 tries: Give multiple choice
# 				§ answer == pendulum; You have a clue!
#
# 		Note 2:  Zkdw orvhv lwv khdg lq wkh pruqlqj dqg jhwv lw edfn dw qljkw?
# 		Decipher: What loses its head in the morning and gets it back at night?
# 			○ answer == something else >>> Wrong. Try again
# 			○ answer === something else 3 tries: Give multiple choice
# 			○ answer == Pillow! You have a clue!
#
#
#
# You've found all the clues! Talk to Dana.
#
# Dana: "Congrats, darling. Now, let me tell you a few things. I married the old man out of love. Don't believe
# anything he tells you nor anything my son says. Xander's adopted, and I feel like I haven't been the best
# mother for him. I try. I do. He really wanted to go to New York last summer, but I was so busy! He can't
# blame me. I wish things could be different. Is it really my fault he burned down the house. Oops, my bad.  All right, I've said too much. Go on to the next room."
#
#
#
# goth_teen = [
